...
export default function StatsSection() {
    ...
    return (
        ...
        >
            ...
            <div className="pointer-events-none absolute top-[50%] left-[50%] h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-50/60 blur-[150px]" />
            ...
            <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
                ...
                >
                    ...
                    <h2 className="mt-4 max-w-lg text-3xl font-medium tracking-tight text-gray-900 sm:text-4xl md:text-5xl lg:text-[3.5rem] lg:leading-[1.1]">
                        What it's like{' '}
                        <span className="text-blue-700">working with ARIA</span>
                    </h2>
                </motion.div>
                ...
                <div ref={ref} className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
                        className="flex flex-col justify-between rounded-3xl bg-blue-100/60 border border-blue-200/40 p-8 md:p-10 lg:row-span-2"
                    >
                        <div>
                            <Quotes size={40} weight="fill" className="mb-6 text-blue-700/30" />
                        ...
                        <div className="mt-8 flex items-center gap-4">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-200 text-sm font-bold text-blue-800">
                                KR
                            </div>
                            <div>
                    ...
                    {stats.map((stat, i) => (
                        <motion.div
                            ...
                            className="flex flex-col justify-center rounded-3xl bg-blue-50/80 border border-blue-100 p-8 md:p-10"
                        >
