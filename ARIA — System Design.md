...
Kitchen, Housekeeping, Maintenance, Spa, FB.
...
| Upsell logic      | Guest checked in 2hrs ago haven't visited FB → fire personalized dinner offer                           |
...
complainthistory  
serviceusage  
churnriskscore        // 0-100, updated by VERA  
vipflag                // boolean  
preferencetags       // 'spa', 'earlycheckout', 'vegetarian'  
lastinteractionat
...
incidentid  
guestid  
type                    // complaint | delay | maintenance | churnrisk  
triggersource          // sentinel | hermes | echo | staff  
severity                // low | medium | high | critical  
actionstaken  
resolvedat  
resolvedby             // aria | staff | manager  
resolutiontimeseconds

### **Agent Action**

actionid  
agentname              // nexus | pulse | echo | hermes | vera  
toolcalled             // sendwhatsapp | pingkitchen | adjustpricing...  
payload{}  
status                  // fired | delivered | failed  
firedat  
guestid (nullable)  
revenueimpact (nullable)
